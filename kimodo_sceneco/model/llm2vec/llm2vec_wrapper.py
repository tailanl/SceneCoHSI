...
class LLM2VecEncoder:
    ...
    def __init__(
        ...
        if "TEXT_ENCODERS_DIR" in os.environ:
            ...
            merged_path = os.path.join(os.environ["TEXT_ENCODERS_DIR"], "McGill-NLP", "LLM2Vec-Meta-Llama-3-8B-Instruct-merged")
            if os.path.isdir(merged_path) and os.path.exists(os.path.join(merged_path, "model.safetensors")):
