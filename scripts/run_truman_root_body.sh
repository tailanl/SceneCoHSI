#!/bin/bash
# =============================================================================
# 实验2: TRUMAN Root+Body SceneCo 训练 (GPU 6)
#
# TRUMAN 24-joint 直接转换 (不经过 SOMA)
# SceneCo 同时注入 root_model + body_model (模型两个 stage 都启用)
# Dual ViT: root 和 body 各用独立 VoxelViT
# =============================================================================
...
# =============================================================================
# Step 2: 训练 root+body SceneCo (GPU 6)
# =============================================================================
echo ""
echo "=============================================="
echo " 实验2: TRUMAN Root+Body SceneCo 训练"
echo " GPU: 6"
echo " SceneCo: root_model + body_model | ViT: dual | Steps: 200k"
echo "=============================================="
...
sys.argv = ['train_truman_root_body.py'] + args
