#!/bin/bash
# train_cakey_sceneco_body_only.sh
# Two-stage training: CaKey -> SceneCo (body_model only).
# Stage 1: Train CaKey in body_model for stable keyframe inbetweening.
# Stage 2: Freeze CaKey, train VoxelViT + SceneCo in body_model.
...
# ---- Stage 1: CaKey Body-Only ----
STAGE1_CONFIG="kimodo_scene_project/configs/stage1_cakey_body_only.yaml"
STAGE1_OUTPUT="kimodo_scene_project/outputs/cakey_body_only"
STAGE1_CKPT="$STAGE1_OUTPUT/checkpoints/best_checkpoint.pt"

echo "=============================================="
echo " STAGE 1: CaKey Body-Only Training"
echo "=============================================="
...
# ---- Stage 2: SceneCo Body-Only (CaKey frozen) ----
STAGE2_CONFIG="kimodo_scene_project/configs/stage2_cakey_sceneco_body_only.yaml"
STAGE2_OUTPUT="kimodo_scene_project/outputs/cakey_sceneco_body_only"
...
echo "=============================================="
echo " STAGE 2: SceneCo Body-Only (CaKey frozen)"
echo "=============================================="
...
echo ""
echo "=============================================="
echo " ALL DONE! CaKey + SceneCo Body-Only training complete."
echo ""
