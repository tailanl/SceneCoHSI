#!/bin/bash
# train_cakey_sceneco_root_body.sh
# Two-stage training: CaKey -> SceneCo (root_model + body_model, independent dual ViT).
# Stage 1: Train CaKey in both root_model and body_model.
# Stage 2: Freeze CaKey, train dual VoxelViT + SceneCo in both root and body.
...
STAGE1_CONFIG="kimodo_scene_project/configs/stage1_cakey_root_body.yaml"
STAGE1_OUTPUT="kimodo_scene_project/outputs/cakey_root_body"
STAGE1_CKPT="$STAGE1_OUTPUT/checkpoints/best_checkpoint.pt"

echo "=============================================="
echo " STAGE 1: CaKey Root+Body Training"
echo "=============================================="
...
# ---- Stage 2: SceneCo Root+Body with Dual ViT (CaKey frozen) ----
STAGE2_CONFIG="kimodo_scene_project/configs/stage2_cakey_sceneco_root_body.yaml"
STAGE2_OUTPUT="kimodo_scene_project/outputs/cakey_sceneco_root_body"
...
echo "=============================================="
echo " STAGE 2: SceneCo Root+Body with Dual ViT (CaKey frozen)"
echo "=============================================="
...
echo ""
echo "=============================================="
echo " ALL DONE! CaKey + SceneCo Root+Body (Dual ViT) training complete."
echo ""
