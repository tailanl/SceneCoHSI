...
This release pertains to Kimodo-SMPLX-RP. This model is for non-commercial research use only.
...
HuggingFace [03/16/2026] via [link](https://huggingface.co/nvidia/Kimodo-SMPLX-RP-v1) <br>
...
- Joint Rotations: Four-Dimensional (`num_frames` x 22 x 3 x 3)
...
**Properties:** 700 hours of captured human body motions with corresponding text descriptions. Split into 90%/10% train/test splits. Various augmentations were employed to expand text and motion variety. Motions were retargeted to SMPL-X body-only skeleton for training.
...
Licensing:                                                                                             |  This model is released under the [NVIDIA Internal Scientific Research and Development Model License](https://www.nvidia.com/en-us/agreements/enterprise-software/nvidia-internal-scientific-research-and-development-model-license)
...
Use Case Restrictions:                              |  Abide by the [license](https://www.nvidia.com/en-us/agreements/enterprise-software/nvidia-internal-scientific-research-and-development-model-license)
